package utils;
//to keep all the endpoints and URI and headers
...
public class APIConstants {
    ...
    public static final String GENERATE_TOKEN_URI = baseURI+"/generateEmployee.php";
    public static final String UPDATE_PARTIALLY_EMPLOYEE_URI = baseURI+"/updatePartialEmplyeesDetails.php";

    // similar you can add endpoint for the rest of endpoints
