...
// method for list of maps
public class DBUtils {
    public static List<Map<String,String>> fetch(String query){

        String dbUrl = ConfigReader.getPropertyValue("dbUrl");// in SDETjavaBAtch16 projrct this method name is getProperty so we need to change it to getPropertyValu
